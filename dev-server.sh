...
echo "💡 Logs: logs/backend-stdout.log (backend stdout)"
echo "         logs/backend-stderr.log (backend stderr)"
echo "         logs/frontend-stdout.log (frontend stdout)"
echo "         logs/frontend-stderr.log (frontend stderr)"
echo ""
echo "💡 For direct terminal output, use: npm run dev:backend or npm run dev:frontend"
